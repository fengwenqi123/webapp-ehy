  ...
  <div>
    <div class="main">
      <div class="content-show">
        ...
        <p v-if="item.status===4"><span>订单待退款中</span></p>
        <p v-if="item.status===4"><span>请稍等...</span></p>
...
export default {
  ...
  created() {
    ...
    console.log('获取的', this.$route.query.infos)
    this.item = JSON.parse(this.$route.query.infos)
    this.isPaid()
    // this.item = JSON.parse(this.$route.query.infos)
  },
  mounted() {
